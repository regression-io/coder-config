...
Once you add a project, several things become possible. The project appears in your quick-switch dropdown so you can jump between projects without hunting through folders. Coder Config watches for a \`.claude\` folder inside that project, and if one exists, it loads the configuration automatically. When you use your AI coding tool in that directory, your rules and settings apply.
