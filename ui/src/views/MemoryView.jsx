    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 dark:bg-slate-900 rounded-lg p-4 border border-transparent dark:border-slate-800">
        ...
        <div className="space-y-1 text-sm text-gray-600 dark:text-slate-400 font-mono">
          <p>coder-config memory                         # Show memory status</p>
          <p>coder-config memory init                    # Initialize project memory</p>
          <p>coder-config memory add &lt;type&gt; "&lt;content&gt;"  # Add entry</p>
          <p>coder-config memory search &lt;query&gt;          # Search all memory</p>
