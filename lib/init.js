...
`);
  ...
  console.log('  2. Install plugins for framework guidance:');
  console.log('     claude plugin marketplace add regression-io/claude-config-plugins');
  console.log('     claude plugin install fastapi-support@claude-config-plugins');
